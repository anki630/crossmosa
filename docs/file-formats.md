...
#define EXPECTED_VERSION 103  // CrossMosa：100 起與上游脫鉤（v132），v187 = 103
#define MAX_STRING_LENGTH 65535
#define FOOTNOTE_NUMBER_LEN 32
#define FOOTNOTE_HREF_LEN 256  // v187（上游 #2722）：註腳紀錄 128 → 288 bytes
...
struct SectionBin {
    ...
    bool boldBodyText;   // v187
    u8 cssState;         // v187: 0 none / 1 full / 2 truncated / 3 truncated-final
