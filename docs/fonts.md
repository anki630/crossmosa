...
| 字型 | 風格 | 漢字涵蓋 | 大小 | 說明 |
|---|---|---|---|---|
| **NotoSerifTC** 思源宋體 | 明體 | 27,950 | 88 MB | 建議先裝這套 |
| **RoundTC** 台灣圓體 | 圓體 | 27,950 | 87 MB | 筆畫末端圓潤，長時間看眼睛比較鬆。有粗體 |
| **NotoSansTC** 思源黑體 | 黑體 | 27,950 | 85 MB | 有粗體，1-bit 下筆畫最穩 |
...
**每一套都收了完整的中文字**——台語文、古文、人名的冷僻字以前會變黑框，現在都有字。
...
**只裝一套也可以**——空間有限就先裝 `NotoSerifTC`。全部裝完約 430 MB，
