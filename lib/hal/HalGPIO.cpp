...
bool HalGPIO::inputActive() {
  ...
  if (inputMgr.isDebouncePending() || inputMgr.getState() != 0) return true;
...
bool HalGPIO::displayIsUc8279() const { return BoardConfig::ACTIVE.board == BoardConfig::Board::XteinkX3Uc8279; }
